$(function () {
  ...
  $('.slider').slick({
    ...
    nextArrow: '<button class="slick-prev slick__btn" type="button"><svg class="icon slick__svg slick__svg--right" style="width: 60px; height: 60px;"><use xlink:href="images/spriteimages/left.svg#left"></use></svg></button >',
    responsive: [{
      breakpoint: 1540,
      settings: {
        arrows: false,
  ...
  // document.querySelector('.minus').addEventListener('click', change);
  // document.querySelector('.plus').addEventListener('click', change);
  ...
  $('.select-style, .card-product__counter').styler();
})